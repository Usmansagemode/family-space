...
<MdxCallout title="MDX Component Demo">
  This callout is rendered from JSX inside an MDX post. It is useful for release
  notes, warnings, and migration tips where you want stronger visual emphasis
  than plain markdown blocks.
</MdxCallout>
