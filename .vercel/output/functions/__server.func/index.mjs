...
import { d as defineLazyEventHandler, H as H3Core } from "./_libs/h3.mjs";
...
const _lazy_iY8Jws = defineLazyEventHandler(() => import("./_chunks/ssr-renderer.mjs"));
const findRoute = /* @__PURE__ */ (() => {
  const data = { route: "/**", handler: _lazy_iY8Jws };
  return ((_m, p) => {
